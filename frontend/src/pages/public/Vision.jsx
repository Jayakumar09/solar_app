      ...
      <section className="py-12 lg:py-16 bg-gradient-to-br from-primary-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div className="text-center max-w-3xl mx-auto mb-10 lg:mb-12" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }}>
            <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">Vision & <span className="text-primary-600">Mission</span></h1>
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-10 mb-16">
            <motion.div className="bg-gradient-to-br from-primary-600 to-primary-700 rounded-3xl p-6 lg:p-8 text-white" initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }}>
            ...
            <motion.div className="bg-white rounded-3xl p-6 lg:p-8 shadow-lg border border-primary-100" initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }}>
